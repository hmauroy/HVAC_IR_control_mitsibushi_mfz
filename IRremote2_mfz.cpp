 ...
 *
 * Mitsubishi HVAC for MFZ-series (floor modelss) added by Henrik Mauroy, Feb 2019
 */
...
/***************************************************************************/
void IRsend::sendHvacMitsubishi_MFZ(
  ...
  int                     HVAC_VanneLower,     // Example VANNE_CLOSED = 0, VANNE_OPEN = 1 (Included by Henrik Mauroy)
...
//#define  HVAC_MITSUBISHI_DEBUG;  // Un comment to access DEBUG information through Serial Interface
  ...
  byte mask = 1; //our bitmask
  byte data[18] = { 0x23, 0xCB, 0x26, 0x01, 0x00, 0x20, 0x08, 0x06, 0x30, 0x45, 0x67, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x1F };
  // data array is a valid trame, only byte to be chnaged will be updated.
  ...
  switch (HVAC_FanMode)
  {
    ...
    case 5:       data[9] = (byte) B10000000; break;  // FAN_SPEED_AUTO
    case 0:       data[9] = (byte) B00000101; break;  // FAN_SPEED_SILENT
    default: break;
  }

  switch (HVAC_VanneMode)
  {
    case 6:          data[9] = (byte) data[9] | B01000000; break; // VANNE_AUTO
    ...
    case 0:          data[9] = (byte) data[9] | B01111000; break; // VANNE_AUTO_MOVE
    default: break;
  }

  // Byte 16 - LOWER VANE (On floor models MFZ) // included by Henrik Mauroy
  switch (HVAC_VanneLower)
  {
    case 0:         data[16] = (byte) 0x02; break; // vane closed (i know, the values are backwards... blame Mitsibushi not me)
    case 1:         data[16] = (byte) 0x00; break; // vane open
    default: break;
  }
