...
class IRsend
{
  ...
  public:
    ...
    void sendHvacMitsubishi_MFZ(
      int                       HVAC_Mode,           // Example HVAC_HOT=1  HvacMitsubishiMode
      int                       HVAC_Temp,           // Example 21  (°c)
      int                       HVAC_FanMode,        // Example FAN_SPEED_AUTO=0  HvacMitsubishiFanMode
      int                       HVAC_VanneMode,      // Example VANNE_AUTO_MOVE=0  HvacMitsubishiVanneMode
      int                       HVAC_VanneLower,     // Example VANNE_CLOSED = 0, VANNE_OPEN = 1     
